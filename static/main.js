...
(() => {
    ...
    window.addEventListener("EYPI-M", e => {
        ...
        Object.defineProperty(HTMLImageElement.prototype, "src", {configurable: true, enumerable: true, get: desc.get, set: function(value) {
            if (value.includes("https://yt3.ggpht.com") && this.parentElement.classList.contains("ytd-comment-renderer")) {
        ...
        s.innerHTML = `yt-img-shadow.ytd-comment-renderer {height: ${size}px !important; width: ${size}px !important; border-radius: ${square ? "0px" : "50%"} !important;} ytd-comment-replies-renderer {margin-left: ${size + 6}px !important;}` 
